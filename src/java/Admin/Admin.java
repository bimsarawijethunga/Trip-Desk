        ...
        try (PrintWriter out = response.getWriter()) {
           String inv = "";
            ...
            String pass = request.getParameter("pass");
			 ...
			 ResultSet rs = stmt.executeQuery("SELECT ad_is,passwd FROM admin");
          		 while (rs.next()) 

	         {       String unam = rs.getString("ad_is");
                  	 String paw = rs.getString("passwd");
                       ...
                       response.sendRedirect("http://localhost:8080/oop/AdminDash");  
...
"            <form method=\"post\" action=\"./Admin\"> <br><br><br><br><br><br><br><br><br>\n" +
"                <h1 style=\"\n" +
"    font-family: 'Open Sans Light';\n" +
"   font-style: normal;\n" +
"   font-weight: 300;\n" +
"    font-size: 25px;\n" +
"    color: aliceblue;\">Admin's Login</h1><br><br>\n" +
